...
from backbone.db.models import *  # noqa: F401, F403 — load all models so Base.metadata is populated
...
def run_migrations_offline() -> None:
    ...
    No database connection required; emits SQL to stdout by default.
    """
